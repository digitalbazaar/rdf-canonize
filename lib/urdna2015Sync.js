...
module.exports = URDNA2015Sync;

var POSITIONS = {'subject': 's', 'object': 'o', 'name': 'g'};

function URDNA2015Sync(options) {
  options = options || {};
  this.name = 'URDNA2015';
...
URDNA2015Sync.prototype.main = function(dataset, callback) {
  var self = this;
  var result;
...
URDNA2015Sync.prototype.hashFirstDegreeQuads = function(id) {
  var self = this;
...
URDNA2015Sync.prototype.hashRelatedBlankNode = function(
...
URDNA2015Sync.prototype.hashNDegreeQuads = function(id, issuer) {
  var self = this;
  ...
  for(var i = 0; i < hashes.length; ++i) {
    ...
    while(permutator.hasNext()) {
      ...
      for(var j = 0; j < recursionList.length; ++j) {
        // 5.4.5.1) Set result to the result of recursively executing
        // the Hash N-Degree Quads algorithm, passing related for
        // identifier and issuer copy for path identifier issuer.
        var related = recursionList[j];
        var result = self.hashNDegreeQuads(related, issuerCopy);
...
URDNA2015Sync.prototype.modifyFirstDegreeComponent = function(id, component) {
  if(component.type !== 'blank node') {
    return component;
  }
...
URDNA2015Sync.prototype.getRelatedPredicate = function(quad) {
  return '<' + quad.predicate.value + '>';
};

// helper for creating hash to related blank nodes map
URDNA2015Sync.prototype.createHashToRelated = function(id, issuer) {
  var self = this;
...
URDNA2015Sync.prototype.forEachComponent = function(quad, op) {
  for(var key in quad) {
    // skip `predicate`
    if(key === 'predicate') {
      continue;
