...
module.exports = class URDNA2015Sync {
  ...
  main(dataset) {
    ...
    for(const quad of dataset) {
      ...
      this._addBlankNodeQuad({quad, component: quad.subject});
      this._addBlankNodeQuad({quad, component: quad.object});
      this._addBlankNodeQuad({quad, component: quad.graph});
    }
  ...
  _addBlankNodeQuad({quad, component}) {
    if(component.termType !== 'BlankNode') {
      return;
    }
